    ...
    <div class="ev-selector" :style="EvComponentStyle" v-if="project">
        ...
        <transition name="fade">
            <EvAppIdOptions
                ...
                :keyword="keyword"
                :projects="projects"
                @select="selectHandler"></EvAppIdOptions>
        </transition>
    </div>
</template>
...
<script>
    ...
    import EvAppIdOptions from "@/evalon-ui/form/basic/EvAppIdGroups";
    ...
    import {
        INITIALIZE_BRANCHES_ACTION,
        INITIALIZE_REPOSITORIES_ACTION,
        SET_MODULE,
        SET_REPOSITORY
    } from "@/store/documata_actions";

    export default {
        name: "ev-app-id-selector",
        data() {
            return {
                keyword: "",
            }
        ...
        methods: {
            ...
            onSelectHandler(option) {
                ...
                //
                // this.$store.commit(SET_REPOSITORY, this.currentRepository)
                //
                // this.$store.commit(SET_MODULE, this.currentModule)
                //
                // this.$store.dispatch(INITIALIZE_BRANCHES_ACTION)
                //
                // this.to(this.AFTER_SELECT, option)
            }
        },
